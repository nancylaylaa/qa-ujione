...
WebUI.verifyElementText(findTestObject('Object Repository/Page_User Management/Search Data Pengajar Invalid/p_Data Pengajar Kosong, klik pada tombol Ta_529690'), 'Data Pengajar Kosong, klik pada tombol `Tambah Pengajar` untuk Menambahkan')
