...
WebUI.click(findTestObject('Object Repository/Page_User Management/Acces Detail Pengajar/p_Akses Mengajar'))

WebUI.verifyElementText(findTestObject('Object Repository/Page_User Management/Acces Detail Pengajar/p_Akses Mengajar'), 'Akses Mengajar')
