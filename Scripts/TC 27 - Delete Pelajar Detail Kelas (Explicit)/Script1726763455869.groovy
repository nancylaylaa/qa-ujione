...
WebUI.waitForElementVisible(findTestObject('Object Repository/Page_Kelas/Access Detail Kelas/Delete Pelajar/button_Ruangan'), 10)
...
WebUI.waitForElementClickable(findTestObject('Object Repository/Page_Kelas/Access Detail Kelas/Delete Pelajar/a_Kelas'), 10)

WebUI.click(findTestObject('Object Repository/Page_Kelas/Access Detail Kelas/Delete Pelajar/a_Kelas'))

WebUI.waitForElementClickable(findTestObject('Object Repository/Page_Kelas/Access Detail Kelas/Delete Pelajar/detailKelas'), 10)

WebUI.click(findTestObject('Object Repository/Page_Kelas/Access Detail Kelas/Delete Pelajar/detailKelas'))

WebUI.waitForElementClickable(findTestObject('Object Repository/Page_Kelas/Access Detail Kelas/Delete Pelajar/hapusPelajar'), 10)

WebUI.click(findTestObject('Object Repository/Page_Kelas/Access Detail Kelas/Delete Pelajar/hapusPelajar'))

WebUI.waitForElementVisible(findTestObject('Object Repository/Page_Kelas/Access Detail Kelas/Delete Pelajar/p_Hapus'), 10)

WebUI.doubleClick(findTestObject('Object Repository/Page_Kelas/Access Detail Kelas/Delete Pelajar/p_Hapus'))

WebUI.waitForElementVisible(findTestObject('Object Repository/Page_Kelas/Access Detail Kelas/Delete Pelajar/span_succesNotif'), 10)

WebUI.verifyElementText(findTestObject('Object Repository/Page_Kelas/Access Detail Kelas/Delete Pelajar/span_succesNotif'),
