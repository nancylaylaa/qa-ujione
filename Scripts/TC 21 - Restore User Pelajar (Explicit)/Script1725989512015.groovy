...
WebUI.waitForElementClickable(findTestObject('Object Repository/Page_User Management/Restore Data User Pelajar/button_Pengaturan User'), 10)
...
WebUI.waitForElementClickable(findTestObject('Object Repository/Page_User Management/Restore Data User Pelajar/a_Pelajar'), 10)

WebUI.click(findTestObject('Object Repository/Page_User Management/Restore Data User Pelajar/a_Pelajar'))

WebUI.waitForElementVisible(findTestObject('Object Repository/Page_User Management/Restore Data User Pelajar/detailPelajar'), 10)

WebUI.click(findTestObject('Object Repository/Page_User Management/Restore Data User Pelajar/detailPelajar'))

WebUI.waitForElementVisible(findTestObject('Object Repository/Page_User Management/Restore Data User Pelajar/button_Hapus'), 10)

WebUI.click(findTestObject('Object Repository/Page_User Management/Restore Data User Pelajar/button_Hapus'))

WebUI.waitForElementVisible(findTestObject('Object Repository/Page_User Management/Restore Data User Pelajar/a_Trash'), 10)

WebUI.click(findTestObject('Object Repository/Page_User Management/Restore Data User Pelajar/a_Trash'))

WebUI.waitForElementClickable(findTestObject('Object Repository/Page_User Management/Restore Data User Pelajar/checkbox'), 10)

WebUI.click(findTestObject('Object Repository/Page_User Management/Restore Data User Pelajar/checkbox'))

WebUI.waitForElementVisible(findTestObject('Object Repository/Page_User Management/Restore Data User Pelajar/button_Restore Yang Dipilih'), 10)

WebUI.click(findTestObject('Object Repository/Page_User Management/Restore Data User Pelajar/button_Restore Yang Dipilih'))

WebUI.waitForElementVisible(findTestObject('Object Repository/Page_User Management/Restore Data User Pelajar/button_restore'), 10)
