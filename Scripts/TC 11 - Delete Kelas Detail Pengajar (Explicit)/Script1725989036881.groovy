...
WebUI.waitForElementClickable(findTestObject('Object Repository/Page_User Management/Acces Detail Pengajar/Delete Kelas/button_Pengaturan User'), 10)
...
WebUI.waitForElementVisible(findTestObject('Object Repository/Page_User Management/Acces Detail Pengajar/Delete Kelas/a_Admin  Pengajar'), 10)

WebUI.click(findTestObject('Object Repository/Page_User Management/Acces Detail Pengajar/Delete Kelas/a_Admin  Pengajar'))

WebUI.waitForElementClickable(findTestObject('Object Repository/Page_User Management/Acces Detail Pengajar/Delete Kelas/crossMark'), 10)

WebUI.click(findTestObject('Object Repository/Page_User Management/Acces Detail Pengajar/Delete Kelas/crossMark'))

WebUI.waitForElementVisible(findTestObject('Object Repository/Page_User Management/Acces Detail Pengajar/Delete Kelas/button_Hapus'), 10)

WebUI.click(findTestObject('Object Repository/Page_User Management/Acces Detail Pengajar/Delete Kelas/button_Hapus'))

WebUI.waitForElementVisible(findTestObject('Object Repository/Page_User Management/Acces Detail Pengajar/Delete Kelas/span_Akses berhasil dihapus'), 10)
