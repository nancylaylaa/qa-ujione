...
WebUI.click(findTestObject('Object Repository/Page_User Management/Acces Detail Pengajar/Add Kelas/span_succesNotif'))

WebUI.verifyElementText(findTestObject('Object Repository/Page_User Management/Acces Detail Pengajar/Add Kelas/span_succesNotif'), 'Akses kelas berhasil ditambahkan')
